                                        ...
                                        <h4>Editar Produto</h4>
                                            <div class="col-md-12 d-flex my-3">
                                                ...
                                                <div id="chip" class="col-md-3">
                                                    <label>Valor</label>
                                                    <input type="number" required class="form-control" name="produto_valor" placeholder="Insira o valor do produto" min="0.00" max="100000.00" step="0.05" value="{{isset($produtoId->produto_valor) ? number_format($produtoId->produto_valor,2) : '' }}">
                                                </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>R$ {{number_format($produtoId->produto_valor,2)}}</td>
