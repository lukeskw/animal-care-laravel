...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Error Page | 419 | Page Expired </title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">O acesso a página expirou</h3>
                                    <p class="text-muted mb-0">Parece que você não tem mais acesso a esta página. Mas não se preocupe... Volte ao início e tente novamente! :D</p>
                                </div>
