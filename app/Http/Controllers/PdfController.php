        ...
        setlocale(LC_TIME, 'pt_BR.utf-8', 'ptb', 'pt_BR', 'portuguese-brazil', 'portuguese-brazilian', 'bra', 'brazil', 'br');
          ...
          if(Auth::check()){
            ...
            if($type==2){
                ...
                ->select('gp.id', 'clientes.nome', 'clientes.id as id_cli', 'clientes.nome_fantasia', 'animals.animal_nome', 'animals.chip', 'procedimentos.procedimento_nome', 'gp.pcd_valor', 'gp.pcd_descricao')->whereMonth('gp.created_at', '=', Carbon::today()->month)->orderBy('clientes.id')->get();
